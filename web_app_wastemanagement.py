...
import { Trash2, MapPin, Users, BarChart3, Leaf, Shield, Clock, TrendingUp, CheckCircle, ArrowRight, Menu, X } from 'lucide-react';

const WasteManagementHomepage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-green-50">
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <div className="flex-shrink-0 flex items-center">
                ...
                <span className="ml-2 text-xl font-bold text-gray-900">WasteTracker</span>
              </div>
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              <button className="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition-all transform hover:scale-105">
                Get Started
              </button>
            </div>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-white border-t">
            <div className="px-2 pt-2 pb-3 space-y-1">
              ...
              <button className="w-full text-left px-3 py-2 text-gray-600 hover:text-gray-900">Sign In</button>
              <button className="w-full text-left px-3 py-2 bg-green-600 text-white rounded-lg">Get Started</button>
            </div>
          </div>
        )}
      </nav>
      ...
      <section className="relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-green-400/20 via-transparent to-blue-400/20 pointer-events-none"></div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
          <div className="text-center">
            <h1 className="text-5xl lg:text-7xl font-bold mb-6">
              <span className="bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent">Smart</span>
              <span className="text-gray-900"> Waste</span>
              <br />
              <span className="text-gray-900">Management</span>
            </h1>
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              Transform your waste management with our intelligent tracking system.
              Monitor, analyze, and optimize your environmental impact.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <button className="bg-green-600 text-white px-8 py-4 rounded-lg hover:bg-green-700 transition-all transform hover:scale-105 flex items-center group">
                Start Tracking
                <ArrowRight className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform" />
              </button>
              <button className="border-2 border-gray-300 text-gray-700 px-8 py-4 rounded-lg hover:border-gray-400 transition-all">
                Learn More
              </button>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              Powerful Features for Sustainable Management
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Everything you need to track, manage, and optimize your waste management processes
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {/* Feature Card 1 */}
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 p-6 rounded-xl border border-green-100 hover:shadow-lg transition-all hover:-translate-y-1">
              <div className="bg-green-100 w-12 h-12 rounded-lg flex items-center justify-center mb-4">
                <MapPin className="h-6 w-6 text-green-600" />
              </div>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Smart Waste Tracking</h3>
              <p className="text-gray-600 text-sm">
                Easily log and categorize different types of waste with our intuitive interface
              </p>
            </div>

            {/* Feature Card 2 */}
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-6 rounded-xl border border-blue-100 hover:shadow-lg transition-all hover:-translate-y-1">
            ...
            {/* Feature Card 3 */}
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 p-6 rounded-xl border border-purple-100 hover:shadow-lg transition-all hover:-translate-y-1">
              <div className="bg-purple-100 w-12 h-12 rounded-lg flex items-center justify-center mb-4">
                <Shield className="h-6 w-6 text-purple-600" />
              </div>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Admin Management</h3>
              <p className="text-gray-600 text-sm">
                Comprehensive admin tools for managing waste collection and processing
              </p>
            </div>

            {/* Feature Card 4 */}
            <div className="bg-gradient-to-br from-orange-50 to-yellow-50 p-6 rounded-xl border border-orange-100 hover:shadow-lg transition-all hover:-translate-y-1">
              <div className="bg-orange-100 w-12 h-12 rounded-lg flex items-center justify-center mb-4">
                <BarChart3 className="h-6 w-6 text-orange-600" />
              </div>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Environmental Impact</h3>
              <p className="text-gray-600 text-sm">
                Track your contribution to environmental sustainability and waste reduction
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold text-gray-900 mb-6">
                Why Choose WasteTracker?
              </h2>
              <p className="text-lg text-gray-600 mb-8">
                Join thousands of organizations and individuals who trust WasteTracker for their waste management needs.
              </p>
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900">Real-time waste tracking and monitoring</h3>
                  </div>
                </div>
                <div className="flex items-start">
                  <CheckCircle className="h-6 w-6 text-green-500 mr-3 flex-shrink-0 mt-0.5" />
                  <div>
                    <h3 className="font-semibold text-gray-900">Automated collection scheduling</h3>
                  </div>
                </div>
                <div className="flex items-start">
                  <CheckCircle className="h-6 w-6 text-green-500 mr-3 flex-shrink-0 mt-0.5" />
                  <div>
                    <h3 className="font-semibold text-gray-900">Comprehensive reporting and analytics</h3>
                  </div>
                </div>
                <div className="flex items-start">
                  <CheckCircle className="h-6 w-6 text-green-500 mr-3 flex-shrink-0 mt-0.5" />
                  <div>
                    <h3 className="font-semibold text-gray-900">Multi-user role management</h3>
                  </div>
                </div>
                <div className="flex items-start">
                  <CheckCircle className="h-6 w-6 text-green-500 mr-3 flex-shrink-0 mt-0.5" />
                  <div>
                    <h3 className="font-semibold text-gray-900">Mobile-responsive design</h3>
                  </div>
                </div>
                <div className="flex items-start">
                  <CheckCircle className="h-6 w-6 text-green-500 mr-3 flex-shrink-0 mt-0.5" />
                  <div>
                    <h3 className="font-semibold text-gray-900">Secure data management</h3>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* CTA Card */}
            <div className="bg-gradient-to-br from-green-600 to-emerald-600 p-8 rounded-2xl text-white shadow-2xl">
              <div className="flex items-center mb-6">
                <div className="bg-white/20 p-3 rounded-lg">
                  <TrendingUp className="h-8 w-8" />
                </div>
                <h3 className="text-2xl font-bold ml-4">Ready to Start?</h3>
              </div>
              ...
              <div className="space-y-4 mb-8">
                <div>
                  <label className="block text-sm font-medium mb-2 text-green-50">For Individuals</label>
                  <p className="text-sm text-green-100">
                    Track your personal waste, set reduction goals, and see your environmental impact in real-time.
                  </p>
                </div>
                <div>
                  <label className="block text-sm font-medium mb-2 text-green-50">For Organizations</label>
                  <p className="text-sm text-green-100">
                    Manage waste across multiple locations with comprehensive analytics and reporting tools.
                  </p>
                </div>
              </div>
              
              <button className="w-full bg-white text-green-600 py-3 rounded-lg font-semibold hover:bg-green-50 transition-all transform hover:scale-105">
                Get Started Now
              </button>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <div className="text-gray-600">Waste Tracked</div>
            </div>
            <div className="text-center">
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center mb-4">
                ...
                <span className="ml-2 text-xl font-bold">WasteTracker</span>
              </div>
              <p className="text-gray-400 text-sm">
                Making waste management smarter and more sustainable.
              </p>
            </div>
            <div>
          ...
          <div className="mt-8 pt-8 border-t border-gray-800 text-center text-gray-400 text-sm">
            © 2025 WasteTracker. All rights reserved.
          </div>
        </div>
      </footer>
    </div>
...
export default WasteManagementHomepage;
